...
int main(int argc, const char **argv) {
  ...
  read_mtx_file(argv[1], A_num_rows, A_num_cols, A_nnz, csr_indptr_buffer, csr_indices_buffer);
...
//          A_num_rows, A_num_cols, A_nnz);
  ...
  int   *hA_csrOffsets = csr_indptr_buffer.data();
  int   *hA_columns    = csr_indices_buffer.data();
